...
namespace TrainManager.UnitTests;
...
public class TrainTest
{
  ...
  public void T01_AddCarriageSimpleTest()
  {
    Train train = new(500);
    Carriage
      newPCar1 = new PassengerCar(60 , 11121111 , 50 , 10),
      newPCar2 = new PassengerCar(50 , 12121112 , 50 , 10),
      newPCar3 = new PassengerCar(40 , 13121113 , 50 , 10),
      newPCar4 = new PassengerCar(40 , 14121114 , 40 , 10),
      newPCar5 = new PassengerCar(40 , 15121115 , 30 , 10);
  ...
  public void T03_AddCarriageSortedTest()
  {
    ...
    Carriage
      ...
      newPCar4 = new PassengerCar(40 , 14121114 , 40 , 10),
      newPCar5 = new PassengerCar(40 , 15121115 , 30 , 10),
      newCCar2 = new CargoCar(50 , 12121112 , 2 , 10);
    ...
    Carriage
      newCCar1_5 = new CargoCar(50 , 16121116 , 3 , 10),
      newCCar2_5 = new CargoCar(50 , 17121117 , 1 , 10);
  ...
  public void T04_CheckCarriageNumberTest()
  {
    Carriage
      newPCar1 = new PassengerCar(60 , 11121111 , 50 , 10),
      newPCar2 = new PassengerCar(50 , 12121113 , 50 , 10),
      newPCar3 = new PassengerCar(40 , 11127133 , 50 , 10),
      newPCar4 = new PassengerCar(40 , 64912451 , 40 , 10),
      newPCar5 = new PassengerCar(40 , 63251679 , 30 , 10);
  ...
  public void T06_CarriageGetProfitTest()
  {
    Carriage
      newPCar1 = new PassengerCar(60 , 11121111 , 50 , 10),
      newCCar2 = new CargoCar(100 , 11121111 , 100 , 20);
  ...
  public void T09_GetMostProfitableCarriageTest()
  {
    ...
    Carriage
      newPCar1 = new PassengerCar(60 , 11121111 , 50 , 10),
      newPCar3 = new PassengerCar(60 , 14121114 , 49 , 11),
      newCCar4 = new CargoCar(60 , 15121115 , 200 , 5),
      newCCar2 = new CargoCar(60 , 12121112 , 2 , 10);
  ...
  public void T10_GetAmoutOfPassengersInTrainTest()
  {
    ...
    Carriage
      newPCar1 = new PassengerCar(60 , 11121111 , 50 , 10),
      newPCar3 = new PassengerCar(60 , 13121113 , 30 , 11),
      newPCar5 = new PassengerCar(60 , 15121115 , 7 , 100),
      newCCar4 = new CargoCar(60 , 14121114 , 200 , 5),
      newCCar2 = new CargoCar(60 , 12121112 , 2 , 10);
  ...
  {
    Train train = new(231);
    CargoCar newCCar2 = new(41 , 12121112 , 5 , 10);
    PassengerCar
      newPCar1 = new(45 , 11121111 , 50 , 10),
      newPCar3 = new(40 , 13121113 , 50 , 10),
      newPCar4 = new(40 , 14121114 , 40 , 10),
      newPCar5 = new(40 , 15121115 , 30 , 10);
